  ...
  template: `
    ...
    >
      ...
      >
        ...
        <div class="flex gap-2 p-1 bg-gray-50 dark:bg-gray-900 rounded-lg">
          <button
      ...
      <div #scrollContainer class="overflow-x-auto pb-4 custom-scrollbar">
        <div
        ...
        >
          ...
          <div
            *ngFor="let event of filteredEvents()"
            class="flex flex-col items-center flex-shrink-0 w-32 relative group cursor-pointer transition-transform hover:scale-105"
          >
            <!-- Timestamp -->
            <span
            ...
            <!-- Tooltip -->
            <div
              class="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:-translate-y-1 pointer-events-none z-20 w-52 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-left rounded-lg p-3 shadow-xl drop-shadow-2xl"
            >
              <p
